...
Windows
1. 패치 ZIP을 기존 NeverTheLast 게임 폴더 안에 풉니다.
   패치 폴더째로 풀어도, 게임 폴더에 바로 풀어도(NeverTheLast.exe 옆) 모두 동작합니다.
2. Apply-Patch.cmd를 실행합니다.
3. 완료 메시지를 확인한 뒤 게임을 실행합니다.

macOS
1. 패치 ZIP을 기존 NeverTheLast 게임 폴더 안에 풉니다.
   패치 폴더째로 풀어도, 게임 폴더에 바로 풀어도(NeverTheLast.app 옆) 모두 동작합니다.
2. Apply-Patch.command를 실행합니다.
