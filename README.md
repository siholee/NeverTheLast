...
**현재 데모 버전: 0.4.4** — 신규 서포터 **이아손**이 합류하고, 메인 메뉴에 육성 카드 열람실이 생겼습니다. 같은 캐릭터를 다시 완주해도 카드가 쌓이며 편성 때 어느 카드로 나갈지 고를 수 있습니다. 신규 장비 9종과 계정 해금 조건 드랍, 가우디·라이트 해금 패시브, 오리온·바스테트·피그말리온 편성 자격 개편이 들어왔습니다. 버전별 변경 사항은 [패치노트](PATCH_NOTES.md)를 보세요.
