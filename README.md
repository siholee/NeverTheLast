...
**현재 데모 버전: 0.3.4** — 수르트·사바흐 입문 추천 편성, 궁극기 자원 이월, 훈련 성장과 힌트 개선, 전투·적 성장 밸런스 조정이 들어왔습니다. 0.3.3에서 ESC 메뉴의 자료실(게임 내 위키), TAB 창 코드 설명, 캐릭터 선택의 기술 보기와 키보드·패드 조작이 추가되었습니다. 버전별 변경 사항은 [패치노트](PATCH_NOTES.md)를 보세요.
