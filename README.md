...
**현재 데모 버전: 0.4.6** (Windows) / **0.4.4** (macOS) — 신규 소환·치유 서포터 **위고**와 우사 추천 편성, 팡세 소환수, 신규 장비 2종이 합류했습니다. 우사의 분신은 이제 피격을 실제로 무효화하며, 소멸한 소환수도 아누비스의 영혼 수확에 포함됩니다. 버전별 변경 사항은 [패치노트](PATCH_NOTES.md)를 보세요.
