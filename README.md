...
**현재 데모 버전: 0.4** — 화이트 아카이브 UI 전면 개편, 메이플스토리체 적용, 전투 결과 화면, 창 모드·해상도·글자/HUD 크기 설정, 전투 화면 배치와 덱 구성 입력 수정이 들어왔습니다. 0.3.4에서 수르트·사바흐 입문 추천 편성, 궁극기 자원 이월, 훈련 성장과 힌트 개선, 전투·적 성장 밸런스 조정이 들어왔습니다. 버전별 변경 사항은 [패치노트](PATCH_NOTES.md)를 보세요.
