...
| **Support** | 20 | 세이 · 가우디 · 라이트 · 니콜 · 잔 · 오리온 · 피그말리온 · 찬드라 · 아그니 · 바유 · 프레이아 · 스카디 · 쿠베라 · 바루나 · 오르페우스 · 아그리파 · 이아손 · 토트 · 이시스 · 마리 |
| **Locked** | 19 | 시 · 아스클레피아 · 아마테라스 · 케찰코아틀 · 츠쿠요미 · 인드라 · 로키 · 수리야 · 스사노오 · 세이메이 · 옥타비아 · 카이사르 · 호루스 · 세트 · 이카리아 · 라부아지에 · 시구르드 · 브륀힐드 · 야마 |

Support 20명 중 라이트·니콜·프레이아·마리는 서포트 완주 후 메인 후보로도 열린다.
이아손은 자신 대신 **옥타비아**를 해금하는 연계 완주 조건을 가진다.
...
**총 45명.** 기초 스탯·레벨당 성장·트레이닝 보너스는 여기서 중복해 적지 않고
...
| 101 | 옥타비아 | 🔴 Locked | Anemo | INT / LUK | 강력한 궁극기 기반 클래식 딜러 |
...
현재 획득 경로가 없는 Locked는 **7명**이다. 옥타비아는 이아손 동행 완주 경로가 생겼다.
...
| 180~199 | 화령 | 1명 | 180 | 우사 |

세이·시·가우디·라이트는 세계관의 중심축인 아카샤 블록에 둔다.
우사는 기존 어느 소속에도 속하지 않아 **화령** 블록을 새로 열었다.
