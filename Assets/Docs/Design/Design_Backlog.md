...
| 5 | 영입 사건 복원 | 🔴 P0 | **Locked 캐릭터 16인 전원 획득 불가** |
...
| 12 | 신규 테마 (스프라이트 선행) | 🟡 P2 | 로마 군단 12종 · 아스완 일반 이단심문관 1종이 임시 스프라이트로 돌아간다 |
...
캐릭터가 늘면서 **막고 있는 것도 함께 커졌다.** 지금 Locked는 16명이고,
...
아스완은 파멸·종말의 성기사, 종말의 이단심문관, 명계의 사령, 타락한 사제,
오시리스, 아문·라까지 전용 자산을 적용했으며 **일반 이단심문관 1종만 임시 자산**이다.
