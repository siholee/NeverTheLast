...
| 25 | 라이트·플라이어 세부 규칙 확정 | 🟠 P1 | 기초 스탯·해금 패시브·소환수 행동/궁극기 규칙·아트가 미확정 |
...
| 19 | **남은 원소 반응** | 감전·화상·촉진·빙결·공명 5종이 있다. **바람·공허**가 낀 조합은 아직 아무 일도 일어나지 않는다 |
...
감전(물+번개)·화상(불+풀)·촉진(풀+번개)·빙결(얼음+물)·공명(바위+바위).
...
| 아트 | `LIGHT_PORTRAIT` / `LIGHT_STANDING` 키만 예약, 원본 미제작 |
