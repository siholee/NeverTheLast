  ...
  public static class CodeFactory
  {
    public static PassiveCode CreatePassiveCode(int codeId, PassiveCodeContext context)
    {
      return codeId switch
      {
        ...
        41 => new SurtrFighter(context, 0.08f, "투사", VoidBeastCodeIds.AllDayLong,
        ...
        // ── 공허의 멧돼지(야수) ──
        1460 => new VoidBeastBruteForce(context),
        1461 => new VoidBeastHardSkin(context, VoidBeastStatusIds.StoneSkin, "void_beast_stone_skin",
            "바위피부", 10, VoidBeastCodeIds.SteelSkin, BaseEnums.CodeGrade.Normal),
        1462 => new VoidBeastArrogance(context),
        1463 => new VoidBeastHardSkin(context, VoidBeastStatusIds.SteelSkin, "void_beast_steel_skin",
            "강철피부", 20, 0, BaseEnums.CodeGrade.Enhanced),
        1464 => new SurtrFighter(context, 0.12f, "하루종일도 할 수 있어", 0,
            BaseEnums.CodeGrade.Enhanced),

        // ── 공허의 늑대 ──
        1470 => new VoidWolfBloodScent(context),
        1471 => new VoidWolfBloodthirst(context, VoidWolfStatusIds.Vampire, "void_wolf_vampire",
            "흡혈귀", 0.25f, VoidWolfCodeIds.DarkLord, BaseEnums.CodeGrade.Normal),
        1472 => new VoidWolfBloodthirst(context, VoidWolfStatusIds.DarkLord, "void_wolf_dark_lord",
            "어둠의 군주", 0.50f, 0, BaseEnums.CodeGrade.Enhanced),

        // ── 공허의 사슴 ──
        1480 => new VoidDeerResonance(context),
        1481 => new VoidAlphaSpecimen(context, VoidSharedStatusIds.AlphaSpecimen, "void_alpha_specimen",
            "알파 개체", 2, VoidSharedCodeIds.Perfection, BaseEnums.CodeGrade.Normal),
        1482 => new VoidStorm(context),
        1483 => new VoidUltimateBarrier(context),
        1484 => new VoidVanguardAura(context),
        1485 => new VoidIntimidation(context),
        1486 => new VoidAlphaSpecimen(context, VoidSharedStatusIds.Perfection, "void_perfection",
            "완전함", 3, 0, BaseEnums.CodeGrade.Enhanced),

        // ── 공허의 기사 ──
        1490 => new VoidKnightArmor(context),

        // ── 공허의 사수 ──
        1500 => new VoidMarksmanSightLine(context),

        // ── 공허의 선봉대 ──
        1510 => new VoidVanguardOath(context),
        1511 => new VoidPhalanxFormation(context),

        // ── 공허의 분쇄자 ──
        1520 => new VoidCrusherMass(context),
        1521 => new VoidCrusherBody(context, VoidCrusherStatusIds.UltimateBody, "void_ultimate_body",
            "궁극의 신체", 2.5f, VoidCrusherCodeIds.TranscendentBody, BaseEnums.CodeGrade.Normal),
        1522 => new VoidCrusherBody(context, VoidCrusherStatusIds.TranscendentBody, "void_transcendent_body",
            "천무지체", 5f, 0, BaseEnums.CodeGrade.Enhanced),
        1523 => new VoidAdaptiveArmor(context),

        // ── 공허의 용 ──
        1530 => new VoidDragonOrigin(context),
        1531 => new VoidAether(context),
        1532 => new VoidPerfectResurrection(context),
        1533 => new VoidElementalMastery(context),
        // ── 장비 전용 패시브 ──
    ...
    public static NormalCode CreateNormalCode(int codeId, NormalCodeContext context)
    {
      return codeId switch
      {
        ...
        1460 => new VoidBeastNormal(context),
        1470 => new VoidWolfNormal(context),
        1490 => new VoidKnightNormal(context),
        1500 => new VoidMarksmanNormal(context),
        1510 => new VoidVanguardNormal(context),
        1520 => new VoidCrusherNormal(context),
        1480 => new VoidDeerNormal(context, BaseEnums.UnitElement.None),
        1481 => new VoidDeerNormal(context, BaseEnums.UnitElement.Pyro),
        1482 => new VoidDeerNormal(context, BaseEnums.UnitElement.Hydro),
        1483 => new VoidDeerNormal(context, BaseEnums.UnitElement.Anemo),
        1484 => new VoidDeerNormal(context, BaseEnums.UnitElement.Electro),
        1485 => new VoidDeerNormal(context, BaseEnums.UnitElement.Dendro),
        1486 => new VoidDeerNormal(context, BaseEnums.UnitElement.Cryo),
        1487 => new VoidDeerNormal(context, BaseEnums.UnitElement.Geo),
        1530 => new VoidDragonNormal(context, BaseEnums.UnitElement.None),
        1531 => new VoidDragonNormal(context, BaseEnums.UnitElement.Pyro),
        1532 => new VoidDragonNormal(context, BaseEnums.UnitElement.Hydro),
        1533 => new VoidDragonNormal(context, BaseEnums.UnitElement.Anemo),
        1534 => new VoidDragonNormal(context, BaseEnums.UnitElement.Electro),
        1535 => new VoidDragonNormal(context, BaseEnums.UnitElement.Dendro),
        1536 => new VoidDragonNormal(context, BaseEnums.UnitElement.Cryo),
        1537 => new VoidDragonNormal(context, BaseEnums.UnitElement.Geo),
    ...
    public static UltimateCode CreateUltimateCode(int codeId, UltimateCodeContext context)
    {
      return codeId switch
      {
        ...
        1460 => new VoidBeastUltimate(context, BaseEnums.UnitElement.None),
        1461 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Pyro),
        1462 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Hydro),
        1463 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Anemo),
        1464 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Electro),
        1465 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Dendro),
        1466 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Cryo),
        1467 => new VoidBeastUltimate(context, BaseEnums.UnitElement.Geo),
        1470 => new VoidWolfUltimate(context, BaseEnums.UnitElement.None),
        1471 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Pyro),
        1472 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Hydro),
        1473 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Anemo),
        1474 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Electro),
        1475 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Dendro),
        1476 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Cryo),
        1477 => new VoidWolfUltimate(context, BaseEnums.UnitElement.Geo),
        1480 => new VoidDeerUltimate(context, 0),
        1481 => new VoidDeerUltimate(context, 1),
        1482 => new VoidDeerUltimate(context, 2),
        1483 => new VoidDeerUltimate(context, 3),
        1484 => new VoidDeerUltimate(context, 4),
        1485 => new VoidDeerUltimate(context, 5),
        1486 => new VoidDeerUltimate(context, 6),
        1487 => new VoidDeerUltimate(context, 7),
        1490 => new VoidKnightUltimate(context, BaseEnums.UnitElement.None),
        1491 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Pyro),
        1492 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Hydro),
        1493 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Anemo),
        1494 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Electro),
        1495 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Dendro),
        1496 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Cryo),
        1497 => new VoidKnightUltimate(context, BaseEnums.UnitElement.Geo),
        1500 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.None),
        1501 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Pyro),
        1502 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Hydro),
        1503 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Anemo),
        1504 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Electro),
        1505 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Dendro),
        1506 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Cryo),
        1507 => new VoidMarksmanUltimate(context, BaseEnums.UnitElement.Geo),
        1510 => new VoidVanguardUltimate(context),
        1520 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.None),
        1521 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Pyro),
        1522 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Hydro),
        1523 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Anemo),
        1524 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Electro),
        1525 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Dendro),
        1526 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Cryo),
        1527 => new VoidCrusherUltimate(context, BaseEnums.UnitElement.Geo),
        1530 => new VoidDragonUltimate(context, BaseEnums.UnitElement.None),
        1531 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Pyro),
        1532 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Hydro),
        1533 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Anemo),
        1534 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Electro),
        1535 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Dendro),
        1536 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Cryo),
        1537 => new VoidDragonUltimate(context, BaseEnums.UnitElement.Geo),
