...
public class UiManager : MonoBehaviour
{
    ...
    private void EnsureUIComponents()
    {
        ...
        if (shopPanel == null)
        {
            ...
            {
                GameObject shopObj = Instantiate(shopPanelPrefab, mainCanvas.transform);
            ...
            else
            {
                ...
                shopPanel.sizeDelta = new Vector2(950f, 120f);
            }
        }
    ...
    private void SetupUIPositions()
    {
        ...
        if (shopPanel != null)
        {
            ...
            shopPanel.anchoredPosition = new Vector2(0f, 15f * scaleY);
            shopPanel.sizeDelta = new Vector2(950f * scaleX, 120f * scaleY);
        }
